-- CEO MER: meta_spend / google_spend / agency_fees / other_fees + blended PNO + media ROAS.
...
monthly AS (
  SELECT
    ...
    s.agency_fees,
    s.other_fees,
    (s.agency_fees + s.other_fees)::numeric AS fees_spend,
    s.agency_fees AS agency_fees_spend,
    s.total_mkt_spend,
    ...
    SELECT
      ...
      CASE
        ...
        THEN ROUND(
          (
            CASE
              WHEN COALESCE(f.agency_journal, 0) > 0 THEN f.agency_journal
