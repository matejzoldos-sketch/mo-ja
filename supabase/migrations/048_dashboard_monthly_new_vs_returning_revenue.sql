-- Mesačné tržby: noví (prvá produktová objednávka lifetime) vs. vracajúci sa; skladaný stĺpcový graf v UI.
-- Zvyšok ako 047 (recentOrders 30d podľa sumy, KPI filter).
...
COMMENT ON FUNCTION public.get_shopify_dashboard_mvp(text, text) IS 'Predaj MVP: monthlyNewVsReturning stacked revenue; optional p_kpi_product; recentOrders 30|90|365d by sum; ytd|30d|90d|365d';
