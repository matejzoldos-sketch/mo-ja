-- Dashboard: optional time range (YTD or rolling N days). Drops zero-arg overload from 002.

DROP FUNCTION IF EXISTS public.get_shopify_dashboard_mvp();
...
COMMENT ON FUNCTION public.get_shopify_dashboard_mvp(text) IS 'MVP JSON for MOJA dashboard: KPIs, daily revenue, top 5 products, 10 recent orders; p_range ytd|30d|90d|365d (Bratislava dates)';
