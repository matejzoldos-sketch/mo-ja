-- KPI: priemerný interval (kalendárne dni, Europe/Bratislava) medzi prvou a druhou produktovou objednávkou v okne.
-- Iba paid-ish + shopify_order_has_product_line + zákazník s returning_group_key; prvé dve objednávky v okne podľa created_at.
...
COMMENT ON FUNCTION public.get_shopify_dashboard_mvp(text) IS 'Predaj MVP: avg_days_first_to_second_purchase (Br dni medzi 1. a 2. produktovou obj. v okne); avg_units_per_unique_customer; topProducts; returning %; LTV; ytd|30d|90d|365d';
