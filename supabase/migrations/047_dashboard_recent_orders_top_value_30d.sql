-- recentOrders: aj 30d = top 10 podľa súčtu produktových riadkov (predtým len 90d, 365d; ytd stále podľa dátumu).
-- Zbytek funkcie zhodný s 045 (KPI filter + get_shopify_dashboard_mvp).
...
COMMENT ON FUNCTION public.get_shopify_dashboard_mvp(text, text) IS 'Predaj MVP: optional p_kpi_product; recentOrders top 10 by product-line sum for 30d|90d|365d (ytd: newest); ytd|30d|90d|365d';
