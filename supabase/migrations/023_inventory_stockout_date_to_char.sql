-- estimated_stockout_date v JSON ako text YYYY-MM-DD (to_char), aby klient vždy dostal čitateľný reťazec.
...
COMMENT ON FUNCTION public.get_shopify_inventory_dashboard IS
  'Inventory × location + YTD avg daily units; estimated_stockout_date as text YYYY-MM-DD (to_char); paid-ish match; non-empty inventoryItemSku only';
