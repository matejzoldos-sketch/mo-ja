-- Zákazníci v okne: % rozdelenie podľa počtu objednávok (1 / 2 / 3 / 4 / 5+) — pie chart v UI.
-- Zvyšok ako 048 (mesačné noví vs. vracajúci sa).
...
COMMENT ON FUNCTION public.get_shopify_dashboard_mvp(text, text) IS 'Predaj MVP: purchaseCountDistribution pie; monthlyNewVsReturning; optional p_kpi_product; ytd|30d|90d|365d';
