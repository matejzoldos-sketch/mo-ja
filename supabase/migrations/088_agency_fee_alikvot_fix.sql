-- Agency alikvot: dailyFee = monthlyFee / daysInMonth; allocated = sum(dailyFee) over selected days.
-- New agency override 900 €/mes from 2026-08-01 until invoices land in the journal.
...
COMMENT ON FUNCTION public.get_executive_scaling_dashboard() IS
  'Executive spend decision: 14d matrix + YTD trends. Agency = daily alikvot; override 900 €/mes from 2026-08-01.';
