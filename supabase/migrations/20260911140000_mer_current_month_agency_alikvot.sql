-- MER: prorate agency fee for current calendar month (Europe/Bratislava)
-- by elapsed days / days in month. Completed months keep full fee.
-- Agency source unchanged: journal > bank > 1014.71 fix from 2026-09-01.
-- Non-agency journal fees stay at full amount.
...
SELECT json_build_object(
  'meta', (
    SELECT json_build_object(
      ...
      'journal_note', 'Fees z denníka (YTD Marketing & Promo); FP 3260023 (1. 4.) = marec. Ak chýba agency fee: Tatra honzabartos, inak od 1. 9. 2026 dočasný fix 1014.71 € (11. 8.); aktuálny mesiac alikvot. Ads z Meta CSV. mROAS = Revenue / (Ads + Fees agentúry). VK Google je vo Fees, nie v mROAS.',
