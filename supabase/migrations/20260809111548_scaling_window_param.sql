...
DROP FUNCTION IF EXISTS public.get_executive_scaling_dashboard();
DROP FUNCTION IF EXISTS public.get_executive_scaling_dashboard(text);
...
COMMENT ON FUNCTION public.get_executive_scaling_dashboard(text) IS
  'Executive spend: window mtd|14d|30d + YTD. Agency 900€ from 2026-07-01. Attribution cannibalization.';
