-- Histogram: počet dní medzi dvoma po sebe idúcimi nákupmi (rovnaká identita), obe objednávky v okne.
-- Zvyšok ako 049 (pie počet nákupov).
...
COMMENT ON FUNCTION public.get_shopify_dashboard_mvp(text, text) IS 'Predaj MVP: purchaseIntervalHistogram; purchaseCountDistribution; monthlyNewVsReturning; optional p_kpi_product; ytd|30d|90d|365d';
