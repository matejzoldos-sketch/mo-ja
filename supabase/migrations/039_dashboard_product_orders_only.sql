...
COMMENT ON FUNCTION public.get_shopify_dashboard_mvp(text) IS 'Predaj MVP: len produktové paid-ish objednávky (≥1 nevyložený riadok); obrat/AOV/denný graf/top zákazníci z qty×unit_price na týchto riadkoch; returning % a LTV na rovnakej báze; tabuľka objednávok = suma produktových riadkov; ytd|30d|90d|365d';
