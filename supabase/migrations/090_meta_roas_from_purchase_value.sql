-- Spend dashboard: real Meta ROAS from purchase_value_eur (CSV conversion value).
-- Keeps agency alikvot override from 088.
...
COMMENT ON FUNCTION public.get_executive_scaling_dashboard() IS
  'Executive spend decision: 14d matrix + YTD trends. Meta ROAS from purchase_value when available.';
