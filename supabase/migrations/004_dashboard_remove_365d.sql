-- Remove 365d / "12 months" range (no historical data). Replaces RPC body from 003.
...
COMMENT ON FUNCTION public.get_shopify_dashboard_mvp(text) IS 'MVP JSON for MOJA dashboard: KPIs, daily revenue, top 5 products, 10 recent orders; p_range ytd|30d|90d (Bratislava dates)';
